...
class ProtoMessageDescriptorTests: XCTestCase {
    ...
    func testInitialization() {
        ...
        // When
        let descriptor = ProtoMessageDescriptor(fullName: fullName, fields: fields, enums: enums, nestedMessages: nestedMessages)
    ...
    func testInvalidMessageDescriptorDuplicateFieldNumbers() {
        ...
        let descriptor = ProtoMessageDescriptor(
            ...
            fields: [
                ProtoFieldDescriptor(name: "field1", number: 1, type: .int32, isRepeated: false, isMap: false),
                ProtoFieldDescriptor(name: "field2", number: 1, type: .string, isRepeated: false, isMap: false) // Same number
            ],
            enums: [],
            nestedMessages: []
        )
