...
final class StaticMessageBridgeVisitorCoverageTests: XCTestCase {
  ...
  func test_toDynamic_doubleValue_fieldExtractedAsDouble() async throws {
  ...
  func test_toDynamic_floatValue_fieldExtractedAsFloat() async throws {
  ...
  func test_toDynamic_int64Value_fieldExtractedAsInt64() async throws {
  ...
  func test_toDynamic_uint64Value_fieldExtractedAsUInt64() async throws {
  ...
  func test_toDynamic_uint32Value_fieldExtractedAsUInt32() async throws {
  ...
  func test_toDynamic_boolValue_fieldExtractedAsBool() async throws {
  ...
  func test_toDynamic_bytesValue_fieldExtractedAsBytes() async throws {
  ...
  func test_visitor_singularMessageField_viaTraverse_recorded() async throws {
  ...
  func test_toDynamic_repeatedStringField_extractedAsRepeated() async throws {
  ...
  func test_toDynamic_repeatedInt32Field_extractedAsRepeated() async throws {
    var msg = Google_Protobuf_FileDescriptorProto()
    msg.name = "test.proto"
  ...
  func test_visitor_repeatedMessageField_viaTraverse_recorded() async throws {
    var msg = Google_Protobuf_FileDescriptorProto()
    msg.name = "test.proto"
  ...
  func test_visitor_mapField_viaStructTraverse_recorded() async throws {
  ...
  func test_visitor_singularSInt32_recorded() async throws {
    var visitor = _FieldExtractorVisitor()
  ...
  func test_visitor_singularGroup_recorded() async throws {
    var visitor = _FieldExtractorVisitor()
  ...
  func test_visitor_repeatedScalarFields_allTypesRecorded() async throws {
    var visitor = _FieldExtractorVisitor()
  ...
  func test_visitor_repeatedEnum_recorded() async throws {
    var visitor = _FieldExtractorVisitor()
  ...
  func test_visitor_repeatedMessage_recorded() async throws {
    var visitor = _FieldExtractorVisitor()
  ...
  func test_visitor_repeatedGroup_recorded() async throws {
    var visitor = _FieldExtractorVisitor()
  ...
  func test_visitor_visitUnknown_doesNotRecordFields() async throws {
    var visitor = _FieldExtractorVisitor()
    try visitor.visitUnknown(bytes: Data([0x01, 0x02]))
    XCTAssertEqual(visitor.extractedFields.count, 0)
  }

  func test_visitor_duplicateFieldNumber_onlyFirstRecorded() async throws {
    var visitor = _FieldExtractorVisitor()
  ...
  func test_isCompatible_staticWithIncompatibleDescriptor_returnsFalse() async throws {
