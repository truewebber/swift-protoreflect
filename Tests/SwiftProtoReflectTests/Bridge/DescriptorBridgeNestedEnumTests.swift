...
final class DescriptorBridgeNestedEnumTests: XCTestCase {
  ...
  func test_fromProtobufDescriptor_nestedEnum_fullNameIsQualified() throws {
  ...
  func test_fromProtobufDescriptor_nestedEnum_bareNameNeverUsedAsFullName() throws {
    let fd = try bridge.fromProtobufFileDescriptor(parentWithEnumFileProto)
    let status = fd.messages["Parent"]!.nestedEnums["Status"]!
    XCTAssertNotEqual(status.fullName, "Status")
  }

  func test_fromProtobufDescriptor_nestedEnum_parentMessageFullNameSet() throws {
    let fd = try bridge.fromProtobufFileDescriptor(parentWithEnumFileProto)
    let status = fd.messages["Parent"]!.nestedEnums["Status"]!
    XCTAssertEqual(status.parentMessageFullName, "pkg.Parent")
  }

  func test_fromProtobufDescriptor_nestedEnum_emptyPackage_noPackagePrefix() throws {
  ...
  func test_fromProtobufDescriptor_multipleNestedEnums_eachQualified() throws {
    let status = makeEnumProto(name: "Status", values: [("UNKNOWN", 0)])
  ...
  func test_fromProtobufDescriptor_nestedEnum_inDoublyNestedMessage_fullyQualified() throws {
  ...
  func test_fromProtobufDescriptor_nestedEnumAndNestedMessage_bothQualified() throws {
    let fd = try bridge.fromProtobufFileDescriptor(parentWithEnumFileProto)
  ...
  func test_fromProtobufDescriptor_nestedEnum_valuesPreserved() throws {
    let fd = try bridge.fromProtobufFileDescriptor(parentWithEnumFileProto)
    let status = fd.messages["Parent"]!.nestedEnums["Status"]!
  ...
  func test_fromProtobufEnumDescriptor_withMessageDescriptorParent_qualifiesCorrectly() throws {
  ...
  func test_fromProtobufEnumDescriptor_withFileDescriptorParent_behaviorUnchanged() throws {
  ...
  func test_fromProtobufEnumDescriptor_withNilParent_fullNameEqualsName() throws {
    let enumProto = makeEnumProto(name: "Status", values: [("UNKNOWN", 0)])
  ...
  func test_fromProtobufDescriptor_nestedEnum_fileDescriptorPathInherited() throws {
    let status = makeEnumProto(name: "Status", values: [("UNKNOWN", 0)])
    let parent = makeMessageProto(name: "Parent", nestedEnums: [status])
  ...
  func test_fromProtobufDescriptor_nestedEnumSameNameAsNestedMessage_bothQualified() throws {
  ...
  func test_fromProtobufDescriptor_nestedMessageWithItsOwnNestedEnum_qualifiedDeep() throws {
  ...
  func test_fromProtobufDescriptor_nestedEnum_noLeadingDot_noPackage() throws {
    let status = makeEnumProto(name: "Status", values: [("UNKNOWN", 0)])
    let parent = makeMessageProto(name: "Parent", nestedEnums: [status])
    let fileProto = makeFileProto(name: "t.proto", package: "", messages: [parent])
    let fd = try bridge.fromProtobufFileDescriptor(fileProto)
  ...
  func test_fromProtobufFileDescriptor_withNestedEnum_fullPipelineQualified() throws {
    let fd = try bridge.fromProtobufFileDescriptor(parentWithEnumFileProto)
    XCTAssertEqual(fd.messages["Parent"]?.nestedEnums["Status"]?.fullName, "pkg.Parent.Status")
  }

  func test_fromProtobufDescriptor_proto2Message_nestedEnum_qualified() throws {
    let status = makeEnumProto(name: "Status", values: [("UNKNOWN", 0)])
    let parent = makeMessageProto(name: "Parent", nestedEnums: [status])
  ...
  func test_fromProtobufDescriptor_nestedEnumValues_accessible() throws {
    let fd = try bridge.fromProtobufFileDescriptor(parentWithEnumFileProto)
    let status = fd.messages["Parent"]!.nestedEnums["Status"]!
    XCTAssertEqual(status.value(named: "ACTIVE")?.number, 1)
  }
