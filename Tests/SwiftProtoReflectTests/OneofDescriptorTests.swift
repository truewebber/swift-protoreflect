...
final class OneofDescriptorTests: XCTestCase {
  ...
  func testImprovedOneofAPI() {
    ...
    let birthdayField = ProtoFieldDescriptor(name: "birthday", number: 5, type: .string, isRepeated: false, isMap: false)
  ...
  func testOneofFieldClearing() {
    ...
    let passportField = ProtoFieldDescriptor(name: "passport", number: 6, type: .string, isRepeated: false, isMap: false)
    let driverLicenseField = ProtoFieldDescriptor(name: "driver_license", number: 7, type: .string, isRepeated: false, isMap: false)
