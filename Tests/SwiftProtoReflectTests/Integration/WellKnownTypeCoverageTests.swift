...
final class WellKnownTypeCoverageTests: XCTestCase {
  ...
  func test_int32ValueHandler_validate_correctType_returnsTrue() async throws {
    XCTAssertTrue(Int32ValueHandler.validate(Int32(42)))
  }

  func test_int32ValueHandler_validate_wrongType_returnsFalse() async throws {
    XCTAssertFalse(Int32ValueHandler.validate("not_int"))
  }

  func test_int64ValueHandler_validate_correctType_returnsTrue() async throws {
    XCTAssertTrue(Int64ValueHandler.validate(Int64(42)))
  }

  func test_int64ValueHandler_validate_wrongType_returnsFalse() async throws {
    XCTAssertFalse(Int64ValueHandler.validate("not_int"))
  }

  func test_uint32ValueHandler_validate_correctType_returnsTrue() async throws {
    XCTAssertTrue(UInt32ValueHandler.validate(UInt32(42)))
  }

  func test_uint32ValueHandler_validate_wrongType_returnsFalse() async throws {
    XCTAssertFalse(UInt32ValueHandler.validate("not_uint"))
  }

  func test_uint64ValueHandler_validate_correctType_returnsTrue() async throws {
    XCTAssertTrue(UInt64ValueHandler.validate(UInt64(42)))
  }

  func test_uint64ValueHandler_validate_wrongType_returnsFalse() async throws {
    XCTAssertFalse(UInt64ValueHandler.validate("not_uint"))
  }

  func test_boolValueHandler_validate_correctType_returnsTrue() async throws {
    XCTAssertTrue(BoolValueHandler.validate(true))
  }

  func test_boolValueHandler_validate_wrongType_returnsFalse() async throws {
    XCTAssertFalse(BoolValueHandler.validate("not_bool"))
  }

  func test_floatValueHandler_validate_correctType_returnsTrue() async throws {
    XCTAssertTrue(FloatValueHandler.validate(Float(1.5)))
  }

  func test_floatValueHandler_validate_wrongType_returnsFalse() async throws {
    XCTAssertFalse(FloatValueHandler.validate("not_float"))
  }

  func test_doubleValueHandler_validate_correctType_returnsTrue() async throws {
    XCTAssertTrue(DoubleValueHandler.validate(Double(3.14)))
  }

  func test_doubleValueHandler_validate_wrongType_returnsFalse() async throws {
    XCTAssertFalse(DoubleValueHandler.validate("not_double"))
  }

  func test_bytesValueHandler_validate_correctType_returnsTrue() async throws {
    XCTAssertTrue(BytesValueHandler.validate(Data([0x01])))
  }

  func test_bytesValueHandler_validate_wrongType_returnsFalse() async throws {
    XCTAssertFalse(BytesValueHandler.validate("not_data"))
  }

  // MARK: - WrapperHandler error paths: missing value field

  func test_int32ValueHandler_createSpecialized_missingValue_throws() async throws {
  ...
  func test_int32ValueHandler_createDynamic_wrongType_throws() async throws {
    XCTAssertThrowsError(try Int32ValueHandler.createDynamic(from: "not_int"))
  }

  func test_int64ValueHandler_createDynamic_wrongType_throws() async throws {
    XCTAssertThrowsError(try Int64ValueHandler.createDynamic(from: "not_int"))
  }

  func test_uint32ValueHandler_createDynamic_wrongType_throws() async throws {
    XCTAssertThrowsError(try UInt32ValueHandler.createDynamic(from: "not_uint"))
  }

  func test_uint64ValueHandler_createDynamic_wrongType_throws() async throws {
    XCTAssertThrowsError(try UInt64ValueHandler.createDynamic(from: "not_uint"))
  }

  func test_boolValueHandler_createDynamic_wrongType_throws() async throws {
    XCTAssertThrowsError(try BoolValueHandler.createDynamic(from: "not_bool"))
  }

  func test_floatValueHandler_createDynamic_wrongType_throws() async throws {
    XCTAssertThrowsError(try FloatValueHandler.createDynamic(from: "not_float"))
  }

  func test_doubleValueHandler_createDynamic_wrongType_throws() async throws {
    XCTAssertThrowsError(try DoubleValueHandler.createDynamic(from: "not_double"))
  }

  func test_bytesValueHandler_createDynamic_wrongType_throws() async throws {
    XCTAssertThrowsError(try BytesValueHandler.createDynamic(from: "not_data"))
  }

  // MARK: - ListValueHandler error paths

  func test_listValueHandler_createSpecialized_wrongDescriptor_throws() async throws {
  ...
  func test_listValueHandler_createDynamic_wrongType_throws() async throws {
  ...
  func test_structValueValue_fromBool_createsCorrectly() async throws {
  ...
  func test_structValueValue_fromString_createsCorrectly() async throws {
  ...
  func test_structValueValue_fromNSNull_createsNullValue() async throws {
  ...
  func test_structValueValue_fromUnsupportedType_throws() async throws {
    XCTAssertThrowsError(try StructHandler.ValueValue(from: Date()))
  }

  // MARK: - StructHandler: createSpecialized wrong descriptor

  func test_structHandler_createSpecialized_wrongDescriptor_throws() async throws {
    var desc = MessageDescriptor(name: "Wrong", fullName: "wrong.Type")
    desc.addField(FieldDescriptor(name: "data", number: 1, type: .bytes))
    let msg = DynamicMessage(descriptor: desc)
