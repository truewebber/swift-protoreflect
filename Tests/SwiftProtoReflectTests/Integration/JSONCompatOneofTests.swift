...
final class JSONCompatOneofTests: XCTestCase {
  ...
  func test_oneof_scalars_double_bidirectional() async throws {
    ...
    try await CompatHelpers.assertUsToProtoc(
      dynamic: dynamic,
      registry: registry,
      protoType: Testcompat_OneofScalars.self
    ) {
      decoded in
  ...
  func test_oneof_unset_emptyJSON() async throws {
  ...
  func test_multiOneof_firstChoice_bidirectional() async throws {
    ...
    try await CompatHelpers.assertUsToProtoc(
      dynamic: dynamic,
      registry: registry,
      protoType: Testcompat_MultiOneof.self
    ) {
      decoded in
  ...
  func test_oneof_wkt_timestamp_bidirectional() async throws {
    ...
    try await CompatHelpers.assertUsToProtoc(dynamic: dynamic, registry: registry, protoType: Testcompat_OneofWKT.self)
    {
      decoded in
