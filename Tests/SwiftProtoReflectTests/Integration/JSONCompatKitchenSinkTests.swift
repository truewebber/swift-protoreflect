...
final class JSONCompatKitchenSinkTests: XCTestCase {
  ...
  func test_kitchenSink_flat_scalars_bidirectional() async throws {
    ...
    try await CompatHelpers.assertUsToProtoc(
      dynamic: dynamic,
      registry: registry,
      protoType: Testcompat_KitchenSinkFlat.self
    ) { decoded in
  ...
  func test_kitchenSink_flat_repeatedAndMap_bidirectional() async throws {
    var proto = Testcompat_KitchenSinkFlat()
  ...
  func test_kitchenSink_flat_wktFields_bidirectional() async throws {
    var proto = Testcompat_KitchenSinkFlat()
  ...
  func test_kitchenSink_flat_oneof_bidirectional() async throws {
    var proto = Testcompat_KitchenSinkFlat()
  ...
  func test_kitchenSink_deepLevel4_bidirectional() async throws {
    ...
    try await CompatHelpers.assertUsToProtoc(
      dynamic: dynamic,
      registry: registry,
      protoType: Testcompat_DeepLevel4.self
    ) {
      decoded in
  ...
  func test_kitchenSink_deepLevel1_full_bidirectional() async throws {
    ...
    try await CompatHelpers.assertUsToProtoc(
      dynamic: dynamic,
      registry: registry,
      protoType: Testcompat_DeepLevel1.self
    ) {
      decoded in
  ...
  func test_kitchenSink_flat_maxValues_bidirectional() async throws {
    var proto = Testcompat_KitchenSinkFlat()
  ...
  func test_kitchenSink_flat_emptyJSON() async throws {
  ...
  func test_kitchenSink_100repeatedNested_bidirectional() async throws {
    var proto = Testcompat_KitchenSinkFlat()
  ...
  func test_kitchenSink_largeMap50entries_bidirectional() async throws {
    var proto = Testcompat_KitchenSinkFlat()
    for i in 1...50 {
  ...
  func test_kitchenSink_deep_withOneofAtEachLevel_bidirectional() async throws {
  ...
  func test_kitchenSink_deepWithExtras_bidirectional() async throws {
  ...
  func test_kitchenSink_flat_singleFieldPopulated_bidirectional() async throws {
    var proto = Testcompat_KitchenSinkFlat()
  ...
  func test_kitchenSink_wideMessage_50fields_bidirectional() async throws {
    ...
    try await CompatHelpers.assertUsToProtoc(
      dynamic: dynamic,
      registry: registry,
      protoType: Testcompat_WideMessage.self
    ) {
      decoded in
