...
final class JSONCompatScalarsTests: XCTestCase {
  ...
  func test_scalars_allTypes_bidirectional() throws {
  ...
  func test_scalars_int64AsQuotedString_bidirectional() throws {
    var proto = Testcompat_ScalarMessage()
  ...
  func test_scalars_uint64AsQuotedString_bidirectional() throws {
    var proto = Testcompat_ScalarMessage()
  ...
  func test_scalars_sint_sfixed_types_bidirectional() throws {
    var proto = Testcompat_ScalarMessage()
  ...
  func test_scalars_bytes_base64_bidirectional() throws {
  ...
  func test_scalars_float_infinity_bidirectional() throws {
    var proto = Testcompat_ScalarMessage()
  ...
  func test_scalars_float_negInfinity_bidirectional() throws {
    var proto = Testcompat_ScalarMessage()
    proto.floatField = -Float.infinity
  ...
  func test_scalars_maxValues_allIntTypes_bidirectional() throws {
    var proto = Testcompat_ScalarMessage()
  ...
  func test_scalars_minValues_allIntTypes_bidirectional() throws {
    var proto = Testcompat_ScalarMessage()
  ...
  func test_scalars_allDefaults_emptyJSON() throws {
  ...
  func test_scalars_singleFieldSet_restDefault_bidirectional() throws {
    var proto = Testcompat_ScalarMessage()
  ...
  func test_scalars_double_nan_bidirectional() throws {
    var proto = Testcompat_ScalarMessage()
  ...
  func test_scalars_double_negInfinity_bidirectional() throws {
    var proto = Testcompat_ScalarMessage()
    proto.doubleField = -Double.infinity
