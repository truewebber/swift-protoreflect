...
final class TimestampHandlerTests: XCTestCase {
    ...
    func testTimestampValueInitialization() {
        ...
        XCTAssertNoThrow(try TimestampHandler.TimestampValue(seconds: 1234567890, nanos: 123456789))
        XCTAssertNoThrow(try TimestampHandler.TimestampValue(seconds: 0, nanos: 0))
        XCTAssertNoThrow(try TimestampHandler.TimestampValue(seconds: -1, nanos: 999999999))
        ...
        XCTAssertThrowsError(try TimestampHandler.TimestampValue(seconds: 0, nanos: 1000000000)) { error in
    ...
    func testTimestampValueFromDate() {
        ...
        XCTAssertTrue(abs(timestamp.nanos - 123456789) < 1000) // До микросекунды точности
    }
    
    func testTimestampValueToDate() {
        do {
            let timestamp = try TimestampHandler.TimestampValue(seconds: 1234567890, nanos: 123456789)
    ...
    func testTimestampValueEquality() {
        do {
            let timestamp1 = try TimestampHandler.TimestampValue(seconds: 1234567890, nanos: 123456789)
            let timestamp2 = try TimestampHandler.TimestampValue(seconds: 1234567890, nanos: 123456789)
            let timestamp3 = try TimestampHandler.TimestampValue(seconds: 1234567890, nanos: 123456790)
    ...
    func testCreateSpecializedFromMessage() throws {
        ...
        let timestampMessage = try createTimestampMessage(seconds: 1234567890, nanos: 123456789)
    ...
    func testCreateSpecializedFromMessageWithMissingFields() throws {
        ...
        let timestampMessage = try createTimestampMessage(seconds: 1234567890, nanos: nil)
    ...
    func testValidate() throws {
        // Валидные значения
        let validTimestamp = try TimestampHandler.TimestampValue(seconds: 1234567890, nanos: 123456789)
    ...
    func testRoundTripConversion() throws {
        let originalTimestamp = try TimestampHandler.TimestampValue(seconds: 1234567890, nanos: 123456789)
    ...
    func testExtremeTimestamps() throws {
        ...
        // Future timestamp
        let future = try TimestampHandler.TimestampValue(seconds: 2147483647, nanos: 999999999)
    ...
    func testMaxNanos() throws {
        ...
        let timestamp = try TimestampHandler.TimestampValue(seconds: 1, nanos: 500000000) // 1.5 секунды
        XCTAssertEqual(timestamp.nanos, 500000000)
        ...
        XCTAssertTrue(abs(roundTrip.nanos - 500000000) < 1000, 
                     "Expected nanos to be close to 500,000,000, but got \(roundTrip.nanos), difference: \(abs(roundTrip.nanos - 500000000))")
    }
    ...
    func testExtremeNanos() throws {
        ...
        let extremeTimestamp = try TimestampHandler.TimestampValue(seconds: 0, nanos: 999999999)
        ...
        XCTAssertTrue(abs(totalOriginalNanos - totalRoundTripNanos) < 1000000,
