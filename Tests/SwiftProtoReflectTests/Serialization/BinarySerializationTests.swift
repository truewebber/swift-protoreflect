...
final class BinarySerializationTests: XCTestCase {
  ...
  func testZigZagEncoding() {
    ...
    XCTAssertEqual(BinarySerializer.zigzagEncode32(2147483647), 4294967294)
    XCTAssertEqual(BinarySerializer.zigzagEncode32(-2147483648), 4294967295)
  ...
  func testSerializeFieldWithMaxNumber() throws {
    ...
    message.addField(FieldDescriptor(name: "max_field", number: 536870911, type: .int32)) // Максимальный номер поля
    fileDescriptor.addMessage(message)
