...
final class JSONFieldMaskTests: XCTestCase {
  ...
  func test_serialize_fieldMask_singlePath_producesCamelCase() throws {
  ...
  func test_serialize_fieldMask_multiplePaths_producesCommaSeparated() throws {
  ...
  func test_serialize_fieldMask_empty_producesEmptyString() throws {
  ...
  func test_serialize_fieldMask_deepPath_producesCamelCase() throws {
  ...
  func test_serialize_fieldMask_alreadyLowercase_unchanged() throws {
  ...
  func test_deserialize_fieldMask_camelCase_toSnakeCase() throws {
  ...
  func test_deserialize_fieldMask_empty_producesEmptyPaths() throws {
  ...
  func test_deserialize_fieldMask_nonString_throwsError() throws {
  ...
  func test_deserialize_fieldMask_singlePath() throws {
  ...
  func test_roundTrip_fieldMask_preservesPaths() throws {
    let original = ["foo_bar", "baz_qux_quux"]
    let msg = try makeFieldMaskMessage(paths: original)

    let data = try canonicalSerializer().serialize(msg)
    let roundTripped = try deserializer().deserialize(data, using: makeFieldMaskDescriptor())
