...
final class JSONSerializerTypeMismatchTests: XCTestCase {
  ...
  func testConvertValueToJSON_doubleField_stringValue() async throws {
  ...
  func testConvertValueToJSON_doubleField_intValue() async throws {
  ...
  func testConvertValueToJSON_doubleField_boolValue() async throws {
  ...
  func testConvertValueToJSON_doubleField_dataValue() async throws {
  ...
  func testConvertValueToJSON_doubleField_arrayValue() async throws {
  ...
  func testConvertValueToJSON_floatField_stringValue() async throws {
  ...
  func testConvertValueToJSON_floatField_int64Value() async throws {
  ...
  func testConvertValueToJSON_floatField_boolValue() async throws {
  ...
  func testConvertValueToJSON_int32Field_stringValue() async throws {
  ...
  func testConvertValueToJSON_int32Field_doubleValue() async throws {
  ...
  func testConvertValueToJSON_int32Field_boolValue() async throws {
  ...
  func testConvertValueToJSON_int64Field_stringValue() async throws {
  ...
  func testConvertValueToJSON_int64Field_floatValue() async throws {
  ...
  func testConvertValueToJSON_uint32Field_stringValue() async throws {
  ...
  func testConvertValueToJSON_uint32Field_doubleValue() async throws {
  ...
  func testConvertValueToJSON_uint64Field_stringValue() async throws {
  ...
  func testConvertValueToJSON_uint64Field_floatValue() async throws {
  ...
  func testConvertValueToJSON_boolField_stringValue() async throws {
  ...
  func testConvertValueToJSON_boolField_intValue() async throws {
  ...
  func testConvertValueToJSON_stringField_intValue() async throws {
  ...
  func testConvertValueToJSON_stringField_boolValue() async throws {
  ...
  func testConvertValueToJSON_stringField_doubleValue() async throws {
  ...
  func testConvertValueToJSON_bytesField_stringValue() async throws {
  ...
  func testConvertValueToJSON_bytesField_intValue() async throws {
  ...
  func testConvertValueToJSON_messageField_stringValue() async throws {
    XCTAssertThrowsError(try serializer.testConvertValueToJSON("not_a_message", type: .message, typeName: nil)) {
      error in
      assertValueTypeMismatch(error, expected: "DynamicMessage", actualContains: "String")
    }
  }

  func testConvertValueToJSON_messageField_intValue() async throws {
  ...
  func testConvertValueToJSON_enumField_stringValue() async throws {
    XCTAssertThrowsError(try serializer.testConvertValueToJSON("not_an_enum", type: .enum, typeName: nil)) { error in
      assertValueTypeMismatch(error, expected: "Int32", actualContains: "String")
    }
  }

  func testConvertValueToJSON_enumField_doubleValue() async throws {
  ...
  func testConvertMapKeyToJSONString_stringKey_intKeyValue() async throws {
  ...
  func testConvertMapKeyToJSONString_stringKey_doubleKeyValue() async throws {
    XCTAssertThrowsError(try serializer.testConvertMapKeyToJSONString(42.5, keyType: .string)) { error in
      assertValueTypeMismatch(error, expected: "String", actualContains: "Double")
    }
  }

  func testConvertMapKeyToJSONString_stringKey_boolKeyValue() async throws {
    XCTAssertThrowsError(try serializer.testConvertMapKeyToJSONString(true, keyType: .string)) { error in
      assertValueTypeMismatch(error, expected: "String", actualContains: "Bool")
    }
  }

  func testConvertMapKeyToJSONString_stringKey_dataKeyValue() async throws {
  ...
  func testConvertMapKeyToJSONString_int64Key_stringKeyValue() async throws {
    XCTAssertThrowsError(try serializer.testConvertMapKeyToJSONString("not_int64", keyType: .int64)) { error in
      assertValueTypeMismatch(error, expected: "Int64", actualContains: "String")
    }
  }

  func testConvertMapKeyToJSONString_int64Key_floatKeyValue() async throws {
    XCTAssertThrowsError(try serializer.testConvertMapKeyToJSONString(Float(42.5), keyType: .int64)) { error in
      assertValueTypeMismatch(error, expected: "Int64", actualContains: "Float")
    }
  }

  func testConvertMapKeyToJSONString_int64Key_boolKeyValue() async throws {
  ...
  func testConvertMapKeyToJSONString_int64Key_dataKeyValue() async throws {
  ...
  func testConvertMapKeyToJSONString_uint32Key_stringKeyValue() async throws {
    XCTAssertThrowsError(try serializer.testConvertMapKeyToJSONString("not_uint32", keyType: .uint32)) { error in
      assertValueTypeMismatch(error, expected: "UInt32", actualContains: "String")
    }
  }

  func testConvertMapKeyToJSONString_uint32Key_doubleKeyValue() async throws {
    XCTAssertThrowsError(try serializer.testConvertMapKeyToJSONString(42.5, keyType: .uint32)) { error in
      assertValueTypeMismatch(error, expected: "UInt32", actualContains: "Double")
    }
  }

  func testConvertMapKeyToJSONString_uint32Key_boolKeyValue() async throws {
  ...
  func testConvertMapKeyToJSONString_uint32Key_dataKeyValue() async throws {
  ...
  func testConvertMapKeyToJSONString_uint64Key_stringKeyValue() async throws {
    XCTAssertThrowsError(try serializer.testConvertMapKeyToJSONString("not_uint64", keyType: .uint64)) { error in
      assertValueTypeMismatch(error, expected: "UInt64", actualContains: "String")
    }
  }

  func testConvertMapKeyToJSONString_uint64Key_floatKeyValue() async throws {
    XCTAssertThrowsError(try serializer.testConvertMapKeyToJSONString(Float(42.5), keyType: .uint64)) { error in
      assertValueTypeMismatch(error, expected: "UInt64", actualContains: "Float")
    }
  }

  func testConvertMapKeyToJSONString_uint64Key_boolKeyValue() async throws {
  ...
  func testConvertMapKeyToJSONString_uint64Key_dataKeyValue() async throws {
  ...
  func testConvertMapKeyToJSONString_boolKey_stringKeyValue() async throws {
    XCTAssertThrowsError(try serializer.testConvertMapKeyToJSONString("true", keyType: .bool)) { error in
      assertValueTypeMismatch(error, expected: "Bool", actualContains: "String")
    }
  }

  func testConvertMapKeyToJSONString_boolKey_intKeyValue() async throws {
    XCTAssertThrowsError(try serializer.testConvertMapKeyToJSONString(Int32(1), keyType: .bool)) { error in
      assertValueTypeMismatch(error, expected: "Bool", actualContains: "Int32")
    }
  }

  func testConvertMapKeyToJSONString_boolKey_doubleKeyValue() async throws {
  ...
  func testConvertMapKeyToJSONString_boolKey_dataKeyValue() async throws {
  ...
  private func assertValueTypeMismatch(
    ...
    XCTAssertTrue(
      actualType.contains(actualContains),
      "Expected '\(actualType)' to contain '\(actualContains)'",
      file: file,
      line: line
    )
  }
