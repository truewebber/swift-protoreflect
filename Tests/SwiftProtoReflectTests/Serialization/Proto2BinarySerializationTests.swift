...
final class Proto2BinarySerializationTests: XCTestCase {
  ...
  func test_group_serialize_wireFormat_startEndGroupTags() async throws {
  ...
  func test_packed_proto3_defaultPacked() async throws {
  ...
  func test_packed_proto2_defaultUnpacked() async throws {
  ...
  func test_packed_proto2_explicitPacked_roundTrip() async throws {
  ...
  func test_packed_proto3_explicitUnpacked_roundTrip() async throws {
  ...
  func test_extension_serialize_roundTrip() async throws {
  ...
  func test_extension_repeated_roundTrip() async throws {
    var desc = MessageDescriptor(name: "Msg", fullName: "test.Msg", syntax: "proto2")
    desc.addField(FieldDescriptor(name: "id", number: 1, type: .int32))
    desc.addExtensionRange(ExtensionRange(start: 100, end: 200))
  ...
  func test_group_repeated_serialize_startEndGroupTagsPerElement() async throws {
    var desc = MessageDescriptor(name: "Msg", fullName: "test.Msg", syntax: "proto2")
    desc.addField(
  ...
  func test_deserializer_acceptsPackedForUnpackedField() async throws {
    ...
    let deserializer = BinaryDeserializer(options: .init(typeRegistry: TypeRegistry()))
    let decoded = try await deserializer.deserialize(packedData, using: unpackedDesc)
    let values = try decoded.get(forField: "values") as? [Any]
    XCTAssertEqual(values?.count, 2)
  }
}
