...
final class Proto2JSONSerializationTests: XCTestCase {
  ...
  func test_jsonSerialize_groupField_asNestedObject() async throws {
  ...
  func test_jsonSerialize_extensionField_included() async throws {
    var desc = MessageDescriptor(name: "Msg", fullName: "test.Msg", syntax: "proto2")
    desc.addField(FieldDescriptor(name: "id", number: 1, type: .int32))
  ...
  func test_jsonRoundTrip_groupField() async throws {
  ...
  func test_jsonRoundTrip_extensionField() async throws {
    let registry = TypeRegistry()
