...
final class DynamicMessageTests: XCTestCase {
  ...
  func testAllScalarTypes() {
    ...
    do {
      ...
      try dynamicMessage.set(Int64(1234567890123), forField: "int64_value")
      try dynamicMessage.set(UInt32(4294967295), forField: "uint32_value")
      try dynamicMessage.set(UInt64(18446744073709551615), forField: "uint64_value")
      try dynamicMessage.set(Int32(-123), forField: "sint32_value")
      try dynamicMessage.set(Int64(-9876543210), forField: "sint64_value")
      ...
      XCTAssertEqual(try dynamicMessage.get(forField: "int64_value") as? Int64, 1234567890123)
      XCTAssertEqual(try dynamicMessage.get(forField: "uint32_value") as? UInt32, 4294967295)
      XCTAssertEqual(try dynamicMessage.get(forField: "uint64_value") as? UInt64, 18446744073709551615)
      XCTAssertEqual(try dynamicMessage.get(forField: "sint32_value") as? Int32, -123)
      XCTAssertEqual(try dynamicMessage.get(forField: "sint64_value") as? Int64, -9876543210)
  ...
  func testRepeatedFieldOperations() {
    ...
    XCTAssertThrowsError(try message.addRepeatedValue(DynamicMessage(descriptor: personMessage), forField: "repeated_message"))
  ...
  func testErrorDescriptions() {
    ...
    let typeMismatchError = DynamicMessageError.typeMismatch(fieldName: "test_field", expectedType: "String", actualValue: 42)
    ...
    let messageMismatchError = DynamicMessageError.messageMismatch(fieldName: "message_field", expectedType: "test.Person", actualType: "test.Address")
    XCTAssertTrue(messageMismatchError.errorDescription?.contains("Несоответствие типа сообщения для поля 'message_field'") ?? false)
