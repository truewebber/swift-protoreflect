...
final class DynamicFieldAccessTests: XCTestCase {
    ...
    override func setUp() {
        ...
        testMessage.addField(FieldDescriptor(
    ...
    func testRepeatedMessageFields() throws {
        ...
        let nested1 = try messageFactory.createMessage(from: nestedMessage, with: [
            "id": Int32(1),
            "label": "First",
            "value": 1.1
        ])
        let nested2 = try messageFactory.createMessage(from: nestedMessage, with: [
            "id": Int32(2),
            "label": "Second",
            "value": 2.2
        ])
        ...
        let nested3 = try messageFactory.createMessage(from: nestedMessage, with: [
            "id": Int32(3),
            "label": "Third",
            "value": 3.3
        ])
    ...
    func testEnumUnknownValues() throws {
        ...
        try message.set(Int32(1000000), forField: "single_enum")  // Очень большое значение
        XCTAssertEqual(try message.get(forField: "single_enum") as? Int32, 1000000)
