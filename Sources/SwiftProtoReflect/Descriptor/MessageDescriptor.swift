...
public enum FieldType {
  ...
  case string
  case bytes
  case message(String)  // Полное имя типа сообщения
  case `enum`(String)   // Полное имя типа перечисления
  case group(String)    // Полное имя типа группы (устаревшее)
}
