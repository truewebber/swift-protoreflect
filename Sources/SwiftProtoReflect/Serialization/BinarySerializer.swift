...
public struct BinarySerializer {
  ...
  private func encodeMessage(_ message: DynamicMessage, to encoder: inout BinaryEncoder) throws {
   ...
   private func encodeField(_ field: FieldDescriptor, from message: DynamicMessage, to encoder: inout BinaryEncoder) throws {
     let fieldAccess = FieldAccessor(message)
   ...
   private func encodeSingleField(_ field: FieldDescriptor, from fieldAccess: FieldAccessor, to encoder: inout BinaryEncoder) throws {
   ...
   private func encodeRepeatedField(_ field: FieldDescriptor, from fieldAccess: FieldAccessor, to encoder: inout BinaryEncoder) throws {
   ...
   private func encodePackedRepeatedField(_ field: FieldDescriptor, values: [Any], to encoder: inout BinaryEncoder) throws {
  ...
  /// Кодирует map поле
  private func encodeMapField(_ field: FieldDescriptor, from fieldAccess: FieldAccessor, to encoder: inout BinaryEncoder) throws {
    guard let mapEntryInfo = field.mapEntryInfo else {
     ...
     for (key, value) in mapValues {
      ...
      var entryEncoder = BinaryEncoder(data: entryData)
       ...
       try encodeValue(value, type: mapEntryInfo.valueFieldInfo.type, typeName: mapEntryInfo.valueFieldInfo.typeName, to: &entryEncoder)
  ...
  private func encodeValue(_ value: Any, type: FieldType, typeName: String?, to encoder: inout BinaryEncoder) throws {
    ...
    case .double:
      guard let doubleValue = value as? Double else {
        throw SerializationError.valueTypeMismatch(expected: "Double", actual: String(describing: Swift.type(of: value)))
      }
    ...
    case .uint32:
      guard let uint32Value = value as? UInt32 else {
        throw SerializationError.valueTypeMismatch(expected: "UInt32", actual: String(describing: Swift.type(of: value)))
      }
      encoder.writeVarint(UInt64(uint32Value))
      
    case .uint64:
      guard let uint64Value = value as? UInt64 else {
        throw SerializationError.valueTypeMismatch(expected: "UInt64", actual: String(describing: Swift.type(of: value)))
      }
    ...
    case .string:
      guard let stringValue = value as? String else {
        throw SerializationError.valueTypeMismatch(expected: "String", actual: String(describing: Swift.type(of: value)))
      }
    ...
    case .message:
      guard let messageValue = value as? DynamicMessage else {
        throw SerializationError.valueTypeMismatch(expected: "DynamicMessage", actual: String(describing: Swift.type(of: value)))
      }
