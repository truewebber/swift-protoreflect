...
public struct BinaryDeserializer {
  ...
  private func decodeMessage(from decoder: inout BinaryDecoder, using descriptor: MessageDescriptor) throws -> DynamicMessage {
  ...
  private func decodeField(_ field: FieldDescriptor, wireType: WireType, from decoder: inout BinaryDecoder, into message: inout DynamicMessage) throws {
  ...
  private func decodeSingleField(_ field: FieldDescriptor, from decoder: inout BinaryDecoder, into message: inout DynamicMessage) throws {
  ...
  private func decodeRepeatedField(_ field: FieldDescriptor, from decoder: inout BinaryDecoder, into message: inout DynamicMessage) throws {
    let value = try decodeValue(type: field.type, typeName: field.typeName, from: &decoder)
  ...
  private func decodePackedRepeatedField(_ field: FieldDescriptor, from decoder: inout BinaryDecoder, into message: inout DynamicMessage) throws {
  ...
  /// Декодирует map поле
  private func decodeMapField(_ field: FieldDescriptor, from decoder: inout BinaryDecoder, into message: inout DynamicMessage) throws {
    ...
    while decoder.position < entryEndPosition {
      ...
      case 2: // value
        value = try decodeValue(type: mapEntryInfo.valueFieldInfo.type, typeName: mapEntryInfo.valueFieldInfo.typeName, from: &decoder)
      default:
