...
struct DynamicClientExample {
    ...
    private static func demonstrateServiceDefinition() throws {
        ...
        listUsersResponse.addField(FieldDescriptor(name: "users", number: 1, type: .message, typeName: "example.grpc.User", isRepeated: true))
    ...
    private static func demonstratePerformanceMetrics() throws {
        ...
        print("    Client Creation: \(String(format: "%.2f", clientCreationTime / Double(clientCreationIterations) * 1000))ms per client")
