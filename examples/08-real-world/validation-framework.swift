...
struct ValidationFrameworkExample {
    static func main() throws {
        ...
        try step1_setupValidationFramework()
        try step2_basicValidationRules()
        try step3_customValidators()
        try step4_conditionalValidation()
        try step5_bulkValidationAndReporting()
    ...
    private static func step1_setupValidationFramework() throws {
    ...
    private static func step2_basicValidationRules() throws {
        ...
        for testCase in testCases {
            ...
            print("  \(testPassed ? "✅" : "❌") \(testCase.name): \(result.isValid ? "Valid" : "Invalid") (\(String(format: "%.2f", validationTime * 1000))ms)")
    ...
    private static func step3_customValidators() throws {
    ...
    private static func step4_conditionalValidation() throws {
    ...
    private static func step5_bulkValidationAndReporting() throws {
