...
struct ConfigurationSystemExample {
    ...
    private static func demonstrateBasicConfiguration() throws {
        ...
        appConfigDescriptor.addField(FieldDescriptor(name: "database", number: 5, type: .message, typeName: "com.app.config.DatabaseConfig"))
        appConfigDescriptor.addField(FieldDescriptor(name: "server", number: 6, type: .message, typeName: "com.app.config.ServerConfig"))
        ...
        ExampleUtils.printDataTable([[
            "Component": "Schema Definition | Configuration Loading | Nested Messages | Type Safety | Hierarchical Structure",
            "Status": "✅ Ready | ✅ Success | ✅ Supported | ✅ Enforced | ✅ Working",
            "Details": "3 message types | Production config | Database + Server | Dynamic validation | Multi-level nesting"
    ...
    private static func demonstrateEnvironmentConfigs() throws {
        ...
        class EnvironmentConfigManager {
            ...
            func compareEnvironments(_ env1: String, _ env2: String) -> [(String, Any?, Any?)] {
                guard let config1 = environments[env1],
                      let config2 = environments[env2] else {
                    return []
                }
        ...
        envManager.addEnvironment("development", config: [
            "app_name": "MyApp (Dev)",
            "version": "2.1.0-dev",
            "debug_mode": true,
        ...
        envManager.addEnvironment("staging", config: [
        ...
        envManager.addEnvironment("production", config: [
            "app_name": "MyApp",
            "version": "2.1.0",
            "debug_mode": false,
    ...
    private static func demonstrateHotReload() throws {
        ...
        appDescriptor.addField(FieldDescriptor(name: "database", number: 1, type: .message, typeName: "com.hotreload.DatabaseConfig"))
    ...
    private static func demonstrateValidationAndDefaults() throws {
        ...
        struct ConfigValidator {
            static func validateAndApplyDefaults(_ config: inout DynamicMessage) -> (isValid: Bool, errors: [String], appliedDefaults: [String]) {
                var errors: [String] = []
        ...
        appDescriptor.addField(FieldDescriptor(name: "server", number: 4, type: .message, typeName: "com.validation.ServerConfig"))
        ...
        ExampleUtils.printDataTable([[
            ...
            "Defaults Applied": "\(emptyResult.appliedDefaults.count) | \(invalidResult.appliedDefaults.count) | \(validResult.appliedDefaults.count)"
