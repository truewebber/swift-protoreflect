...
struct NestedOperationsExample {
    ...
    private static func step1_deepTraversal() throws {
        ...
        var engineeringDept = try createDepartment(factory: factory, fileDescriptor: fileDescriptor,
                                                 name: "Engineering", budget: 1500000.0)
        
        var backendTeam = try createTeam(factory: factory, fileDescriptor: fileDescriptor,
                                       name: "Backend Team", size: 8)
        
        var frontendTeam = try createTeam(factory: factory, fileDescriptor: fileDescriptor,
                                        name: "Frontend Team", size: 6)
        
        // Create projects
        let project1 = try createProject(factory: factory, fileDescriptor: fileDescriptor,
                                       name: "API Redesign", status: "active", priority: 1)
        
        let project2 = try createProject(factory: factory, fileDescriptor: fileDescriptor,
                                       name: "UI Overhaul", status: "planning", priority: 2)
    ...
    private static func step2_batchNestedOperations() throws {
        ...
        var blog = try createBlog(factory: factory, fileDescriptor: fileDescriptor,
                                name: "Tech Blog", description: "Latest tech insights")
        
        // Create categories with posts
        var category1 = try createCategory(factory: factory, fileDescriptor: fileDescriptor,
                                         name: "AI & ML", slug: "ai-ml")
        
        var category2 = try createCategory(factory: factory, fileDescriptor: fileDescriptor,
                                         name: "Web Dev", slug: "web-dev")
        
        // Batch create posts
        let posts1 = try createBatchPosts(factory: factory, fileDescriptor: fileDescriptor,
                                        count: 3, categoryName: "AI")
        
        let posts2 = try createBatchPosts(factory: factory, fileDescriptor: fileDescriptor,
                                        count: 2, categoryName: "Web")
    ...
    private static func step3_conditionalTransforms() throws {
        ...
        var store = try createStore(factory: factory, fileDescriptor: fileDescriptor,
                                  name: "Tech Store", currency: "USD")
    ...
    private static func step4_pathNavigation() throws {
        ...
        var university = try createUniversity(factory: factory, fileDescriptor: fileDescriptor,
                                            name: "Tech University", established: 1985)
    ...
    private static func createCompanyStructure() throws -> FileDescriptor {
        ...
        companyDesc.addField(FieldDescriptor(
            name: "departments",
            number: 2,
            type: .message,
    ...
    private static func createBlogStructure() throws -> FileDescriptor {
        ...
        blogDesc.addField(FieldDescriptor(
            name: "categories",
            number: 3,
            type: .message,
    ...
    private static func createProductStructure() throws -> FileDescriptor {
        ...
        storeDesc.addField(FieldDescriptor(
            name: "categories",
            number: 3,
            type: .message,
    ...
    private static func createUniversityStructure() throws -> FileDescriptor {
        ...
        universityDesc.addField(FieldDescriptor(
            name: "faculties",
            number: 3,
            type: .message,
        ...
        facultyDesc.addField(FieldDescriptor(
            name: "students",
            number: 2,
            type: .message,
    ...
    private static func createTreeStructure() throws -> FileDescriptor {
        ...
        nodeDesc.addField(FieldDescriptor(
            name: "children",
            number: 3,
            type: .message,
    ...
    private static func createDepartment(factory: MessageFactory, fileDescriptor: FileDescriptor, name: String, budget: Double) throws -> DynamicMessage {
    ...
    private static func createTeam(factory: MessageFactory, fileDescriptor: FileDescriptor, name: String, size: Int) throws -> DynamicMessage {
    ...
    private static func createProject(factory: MessageFactory, fileDescriptor: FileDescriptor, name: String, status: String, priority: Int) throws -> DynamicMessage {
    ...
    private static func createBlog(factory: MessageFactory, fileDescriptor: FileDescriptor, name: String, description: String) throws -> DynamicMessage {
    ...
    private static func createCategory(factory: MessageFactory, fileDescriptor: FileDescriptor, name: String, slug: String) throws -> DynamicMessage {
    ...
    private static func createBatchPosts(factory: MessageFactory, fileDescriptor: FileDescriptor, count: Int, categoryName: String) throws -> [DynamicMessage] {
    ...
    private static func createStore(factory: MessageFactory, fileDescriptor: FileDescriptor, name: String, currency: String) throws -> DynamicMessage {
    ...
    private static func createProductCatalog(factory: MessageFactory, fileDescriptor: FileDescriptor) throws -> [DynamicMessage] {
    ...
    private static func applyDiscountToExpensiveItems(_ store: DynamicMessage, threshold: Double, discount: Double) throws -> Int {
    ...
    private static func createUniversity(factory: MessageFactory, fileDescriptor: FileDescriptor, name: String, established: Int) throws -> DynamicMessage {
    ...
    private static func createFacultiesWithStudents(factory: MessageFactory, fileDescriptor: FileDescriptor) throws -> [DynamicMessage] {
    ...
    private static func navigateToStudentGPA(_ university: DynamicMessage, facultyIndex: Int, studentIndex: Int) throws -> Double {
    ...
    private static func findHonorsStudents(_ university: DynamicMessage, gradeThreshold: Double) throws -> [DynamicMessage] {
    ...
    private static func createLargeTree(factory: MessageFactory, fileDescriptor: FileDescriptor, depth: Int) throws -> DynamicMessage {
