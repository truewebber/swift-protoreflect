...
struct PerformanceOptimization {
    ...
    static func main() throws {
        ...
        try step1_performanceBenchmarking()
        try step2_memoryEfficientOperations()
        try step3_batchProcessingOptimizations()
        try step4_cachingStrategies()
        try step5_lazyLoadingAndStreaming()
        try step6_advancedOptimizationPatterns()
    ...
    private static func step1_performanceBenchmarking() throws {
    ...
    private static func step2_memoryEfficientOperations() throws {
    ...
    private static func step3_batchProcessingOptimizations() throws {
    ...
    private static func step4_cachingStrategies() throws {
    ...
    private static func step5_lazyLoadingAndStreaming() throws {
    ...
    private static func step6_advancedOptimizationPatterns() throws {
...
extension PerformanceOptimization {
    ...
    static func createLargeTestDataset(factory: MessageFactory, fileDescriptor: FileDescriptor, count: Int) throws -> [DynamicMessage] {
    ...
    static func simpleCachingApproach(factory: MessageFactory, fileDescriptor: FileDescriptor, cache: FieldCache) throws -> Int {
        var operationCount = 0
    ...
    static func smartCachingApproach(factory: MessageFactory, fileDescriptor: FileDescriptor, cache: SmartCache) throws -> Int {
        var operationCount = 0
    ...
    static func eagerLoadingApproach(factory: MessageFactory, fileDescriptor: FileDescriptor, count: Int) throws -> [DynamicMessage] {
    ...
    static func accessLazyData(_ loader: LazyMessageLoader) throws -> Int {
        ...
        for i in [0, 10, 50, 100, 200, 500, 999] {
            if i < loader.totalCount {
    ...
    static func windowedLoadingApproach(factory: MessageFactory, fileDescriptor: FileDescriptor, windowSize: Int, totalCount: Int) throws -> Int {
        var processedCount = 0
        ...
        for windowIndex in 0..<windowCount {
            ...
            // Load window
            let windowData = try createLargeTestDataset(factory: factory, fileDescriptor: fileDescriptor, count: currentWindowSize)
...
class COWMessage {
    ...
    private func ensureUnique() throws {
        if isShared {
            ...
            // Copy all fields
            for field in _message.descriptor.fields.values {
                if try _message.hasValue(forField: field.name) {
