...
extension ConditionalLogicExample {
    ...
    static func createMixedMediaItems(factory: MessageFactory, fileDescriptor: FileDescriptor) throws -> [DynamicMessage] {
        ...
        try imageItem.set(Int64(2485760), forField: "size")
        ...
        try videoItem.set(Int64(104857600), forField: "size")
    ...
    static func processShapePolymorphically(_ shape: DynamicMessage) throws {
        ...
        case "circle":
            ...
            print("        📐 Circle: radius=\(radius), area=\(String(format: "%.2f", area)), perimeter=\(String(format: "%.2f", perimeter))")
        case "rectangle":
            let width = param1
            let height = param2
            let area = width * height
            let perimeter = 2 * (width + height)
            print("        📐 Rectangle: \(width)x\(height), area=\(String(format: "%.2f", area)), perimeter=\(String(format: "%.2f", perimeter))")
        case "triangle":
            let side = param1
            let area = (sqrt(3) / 4) * side * side
            let perimeter = 3 * side
            print("        📐 Triangle: side=\(side), area=\(String(format: "%.2f", area)), perimeter=\(String(format: "%.2f", perimeter))")
        default:
    ...
    static func getUserSummary(_ user: DynamicMessage) throws -> String {
        ...
        let typeString = switch userType {
        case 0: "Regular"
        case 1: "Premium"
        case 2: "Admin"
        default: "Unknown"
    ...
    static func getEventType(_ event: DynamicMessage) throws -> String {
        ...
        let typeString = switch eventType {
        case 0: "User Event"
        case 1: "System Event"
    ...
    static func createComplexTypedStructures(factory: MessageFactory, fileDescriptor: FileDescriptor) throws -> [DynamicMessage] {
