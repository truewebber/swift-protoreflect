...
struct NestedTypesExample {
    static func main() throws {
        ...
        try step1_basicNestedEnum()
        try step2_nestedMessage()
        try step3_complexHierarchy()
        try step4_nestedTypeAccess()
        try step5_realWorldExample()
    ...
    private static func step1_basicNestedEnum() throws {
    ...
    private static func step2_nestedMessage() throws {
        ...
        guard let addressDesc = companyDesc.nestedMessage(named: "Address") else {
            throw NSError(domain: "Example", code: 1, userInfo: [NSLocalizedDescriptionKey: "Address nested message not found"])
        }
    ...
    private static func step3_complexHierarchy() throws {
        ...
        guard let chapterDesc = documentDesc.nestedMessage(named: "Chapter") else {
            throw NSError(domain: "Example", code: 1, userInfo: [NSLocalizedDescriptionKey: "Chapter nested message not found"])
        }
        ...
        guard let sectionDesc = chapterDesc.nestedMessage(named: "Section") else {
            throw NSError(domain: "Example", code: 1, userInfo: [NSLocalizedDescriptionKey: "Section nested message not found"])
        }
    ...
    private static func step4_nestedTypeAccess() throws {
    ...
    private static func step5_realWorldExample() throws {
        ...
        guard let paymentDesc = orderDesc.nestedMessage(named: "Payment") else {
            throw NSError(domain: "Example", code: 1, userInfo: [NSLocalizedDescriptionKey: "Payment nested message not found"])
        }
    ...
    private static func createComplexHierarchyStructure() throws -> FileDescriptor {
        ...
        chapterDesc.addField(FieldDescriptor(
            name: "sections",
            number: 3,
            type: .message,
