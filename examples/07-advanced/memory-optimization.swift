...
struct MemoryOptimizationExample {
    ...
    private static func demonstrateObjectPooling() throws {
        ...
        ExampleUtils.printDataTable([[
            ...
            "Time": "\(String(format: "%.3f", withoutPoolingTime.time * 1000))ms | \(String(format: "%.3f", withPoolingTime.time * 1000))ms | N/A",
    ...
    private static func demonstrateLazyLoading() throws {
        ...
        ExampleUtils.printDataTable([[
            ...
            "Time": "\(String(format: "%.3f", eagerTime.time * 1000))ms | \(String(format: "%.3f", lazyTime.time * 1000))ms",
    ...
    private static func demonstrateStreamingProcessing() throws {
        ...
        ExampleUtils.printDataTable([[
            ...
            "Value": "\(processor.totalProcessed) | \(chunkSize) | \(String(format: "%.2f", memoryEfficiency))% of total | \(String(format: "%.0f", throughput)) rec/s | Constant",
    ...
    private static func demonstrateMemoryPressureHandling() throws {
        ...
        ExampleUtils.printDataTable([[
            ...
            "Value": "\(finalStats.processed) | \(finalStats.cached) | \(String(format: "%.1f", finalStats.memoryUsage))% | Simulated | As needed",
    ...
    private static func demonstrateMemoryProfiling() throws {
        ...
        ExampleUtils.printDataTable([[
            ...
            "Value": "\(totalAllocated) | \(totalDeallocated) | \(totalCurrent) | \(totalPeak) | \(String(format: "%.1f", Double(totalDeallocated)/Double(totalAllocated)*100))%",
