...
struct StaticMessageBridgeExample {
    ...
    private static func demonstrateComplexMessageConversion() throws {
        ...
        employeeDescriptor.addField(FieldDescriptor(name: "status", number: 3, type: .enum, typeName: "com.enterprise.EmployeeStatus"))
        employeeDescriptor.addField(FieldDescriptor(name: "address", number: 4, type: .message, typeName: "com.enterprise.Address"))
        ...
        departmentDescriptor.addField(FieldDescriptor(name: "employees", number: 3, type: .message, typeName: "Employee", isRepeated: true))
        ...
        companyDescriptor.addField(FieldDescriptor(name: "headquarters", number: 2, type: .message, typeName: "com.enterprise.Address"))
        companyDescriptor.addField(FieldDescriptor(name: "departments", number: 3, type: .message, typeName: "com.enterprise.Department", isRepeated: true))
        ...
        let complexityData = [
            ...
            ["Component": "Level 2 (ContactInfo)", "Levels": "1", "Static Fields": "2", "Dynamic Navigation": "✅ Nested access"],
    ...
    private static func demonstrateNestedMessageHandling() throws {
        ...
        level3Descriptor.addField(FieldDescriptor(name: "level4_list", number: 3, type: .message, typeName: "com.nested.Level4", isRepeated: true))
        ...
        let navigationData = [
            ...
            ["Path": "root.person.contact.address.country", "Access Method": "3-level", "Performance": "O(1)", "Success": "✅"]
        ]
    ...
    private static func demonstrateBatchConversion() throws {
        ...
        let batchResults = [
            ["Metric": "Messages Created", "Value": "\(batchSize)", "Performance": "✅ \(String(format: "%.0f", Double(batchSize) / userCreationTime.time))/sec"],
            ["Metric": "Conversion Time", "Value": "\(String(format: "%.1f", batchConversionTime.time * 1000))ms", "Performance": "✅ \(String(format: "%.0f", Double(batchSize) / batchConversionTime.time))/sec"],
