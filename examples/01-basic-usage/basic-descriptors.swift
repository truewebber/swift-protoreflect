...
struct BasicDescriptorsExample {
    static func main() throws {
        ...
        try step1_fileDescriptorNavigation()
        try step2_messageDescriptorDetails()
        try step3_fieldDescriptorAnalysis()
        try step4_enumDescriptorExploration()
        try step5_typeRelationships()
    ...
    private static func step1_fileDescriptorNavigation() throws {
    ...
    private static func step2_messageDescriptorDetails() throws {
    ...
    private static func step3_fieldDescriptorAnalysis() throws {
    ...
    private static func step4_enumDescriptorExploration() throws {
    ...
    private static func step5_typeRelationships() throws {
