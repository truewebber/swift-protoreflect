...
struct ProtobufSerializationExample {
    static func main() throws {
        ...
        try step1_basicSerialization()
        try step2_complexMessageSerialization()
        try step3_roundTripCompatibility()
        try step4_performanceAnalysis()
        try step5_wireFormatAnalysis()
    ...
    private static func step1_basicSerialization() throws {
    ...
    private static func step2_complexMessageSerialization() throws {
    ...
    private static func step3_roundTripCompatibility() throws {
        ...
        let isValid = ExampleUtils.assertEqual(finalName, "Round Trip User", description: "Name preservation") &&
    ...
    private static func step4_performanceAnalysis() throws {
    ...
    private static func step5_wireFormatAnalysis() throws {
    ...
    private static func benchmarkSerialization(messageCount: Int) throws -> ([DynamicMessage], Data, TimeInterval, TimeInterval) {
        let serializer = BinarySerializer()
        let deserializer = BinaryDeserializer()
