...
struct FileLoadingExample {
    ...
    private static func step1_basicFileCreationAndStructure() throws {
        ...
        for (fileName, deps) in dependencies {
            if !deps.isEmpty {
