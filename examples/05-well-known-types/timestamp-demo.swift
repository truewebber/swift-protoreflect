...
struct TimestampDemo {
    ...
    private static func demonstrateBasicUsage() throws {
        ...
        // Конвертация обратно
        let extractedValue = try TimestampHandler.createSpecialized(from: timestampMessage) as! TimestampHandler.TimestampValue
    ...
    private static func demonstrateAdvancedOperations() throws {
        ...
        let significantTimestamps = [
            ...
            ("Y2K moment", Date(timeIntervalSince1970: 946684800)),
            ("Swift announcement", Date(timeIntervalSince1970: 1401843600)), // WWDC 2014
        ...
        print("    Original microseconds: \(String(format: "%.6f", preciseTime.timeIntervalSince1970.truncatingRemainder(dividingBy: 1)))")
        print("    Reconstructed microseconds: \(String(format: "%.6f", nanoReconstructed.timeIntervalSince1970.truncatingRemainder(dividingBy: 1)))")
    ...
    private static func demonstrateRoundTripCompatibility() throws {
        ...
        let testDates = [
            ...
            Date(timeIntervalSince1970: -1234567890),           // Before epoch
        ]
    ...
    private static func demonstrateEdgeCases() throws {
        ...
        let edgeCases = [
            ...
            ("Very large valid", Date(timeIntervalSince1970: 253402300799)), // Max valid timestamp
            ("Negative timestamp", Date(timeIntervalSince1970: -62135596800)), // Min valid
            ("Current moment", Date()),
        ]
        ...
        for (label, date) in edgeCases {
            do {
                ...
                // Validation checks
                let isValid = timestampValue.seconds >= -62135596800 && timestampValue.seconds <= 253402300799
                let nanosValid = timestampValue.nanos >= 0 && timestampValue.nanos < 1000000000
