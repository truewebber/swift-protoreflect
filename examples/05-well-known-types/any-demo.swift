...
struct AnyDemo {
    ...
    private static func createTestMessages() throws -> [(String, DynamicMessage)] {
        ...
        try simpleMessage.set(Int64(1702648200), forField: "timestamp")
    ...
    private static func filterAnyMessagesByType(_ anyValues: [AnyHandler.AnyValue], typeName: String) -> [AnyHandler.AnyValue] {
    ...
    private static func processEvent(_ anyEvent: DynamicMessage) throws -> (status: String, handler: String, duration: String) {
